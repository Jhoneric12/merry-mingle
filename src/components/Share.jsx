    ...
    return (
        <div>
            ...
            <div className='grid grid-cols-2 md:grid-cols-3 gap-4 py-10 px-4 md:px-40 lg:px-96'>
                {
                    ShareGifts.map(share => (
                        <div key={share.id} className=' dark:bg-dark-container-color py-4 rounded-lg shadow-md flex items-center flex-col place-items-center'>
                            {/* <div>
