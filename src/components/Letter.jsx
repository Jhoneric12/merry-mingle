...
function Letter() {
  return (
    <div className='py-24 px-10 md:px-30 lg:px-40 flex justify-center items-center'>
        <div className='bg-light-primary-color w-full rounded-xl py-10 px-4 md:flex justify-center gap-10'>
            <div className='flex flex-col justify-center items-center md:items-start md:w-[40%]'>
                ...
                <input type="text" className=' rounded-full py-4 px-6 w-[80%] md:w-full text-sm mt-6' placeholder='Write your message'/>
                <Button
                    btnText={'Send Message'}
                    styles={'bg-light-title-color w-[80%]'}
                />
            </div>
